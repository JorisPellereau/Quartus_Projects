...
# Reuse from http://idlelogiclabs.com/2012/04/15/talking-to-the-de0-nano-using-the-virtual-jtag-interface/
...
proc set_LEDs {send_data} {
    ...
    device_virtual_dr_shift -dr_value $send_data -instance_index 0 -length 7 -no_captured_dr_value -value_in_hex
